...
# fmt: on
    ...
    if const_expr(mfma._skip_empty_m16):
        ...
        a_gather.set_m_active(a_valid_rows)
...
def build_fused_gemm1(*, x_tensor, w_rsrc, sw_rsrc, sx_rsrc,
    ...
    mfma = MfmaScaleGU(m_repeat=m_repeat, num_acc_n=num_acc_n, prefetch_a_operand=prefetch_a_operand, skip_empty_m16=skip_empty_m16)
    if skip_empty_m16:
        assert sort_block_m == 64 and tile_n == 512
        assert m_repeat == 4 and num_acc_n == 4 and tvr_rsrc is not None
